...
//        val hasKey: Boolean = state["hasKey"]; // get whether the player has the key or not
        ...
        canvas.drawCircle(cellSize.toFloat() / 2, cellSize.toFloat() / 2 + 20,
            cellSize.toFloat()/2 - 30, paint)
        // hat
        paint.color = Color.BLACK
        canvas.drawRect(15f, 70f, 140f, 80f, paint)
        canvas.drawRect(40f, 30f, 115f, 80f, paint)

        // hat band
        paint.color = Color.RED
        canvas.drawRect(40f, 60f, 115f, 70f, paint)

        // eyes
        paint.color = Color.WHITE
        canvas.drawRect(55f, 90f, 65f, 100f, paint)
        canvas.drawRect(95f, 90f, 105f, 100f, paint)
    }
